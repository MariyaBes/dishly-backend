    ...
    <div>
      ...
      <div className="table-responsive">
        {orderItemList && orderItemList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Dish <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderItemList.map((orderItem, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{orderItem.dish ? <Link to={`/dish/${orderItem.dish.id}`}>{orderItem.dish.id}</Link> : ''}</td>
          ...
          !loading && <div className="alert alert-warning">Order Items не найдено</div>
        )}
      </div>
    </div>
  );
