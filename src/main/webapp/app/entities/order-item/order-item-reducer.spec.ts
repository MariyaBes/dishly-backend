...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERITEM actions', async () => {
      const arg = 42666;
