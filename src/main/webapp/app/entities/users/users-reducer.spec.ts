...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './users.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERS actions', async () => {
      const arg = 42666;
