...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHIEFLINKS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHIEFLINKS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHIEFLINKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHIEFLINKS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHIEFLINKS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHIEFLINKS actions', async () => {
      const arg = 42666;
