...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './chief.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHIEF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHIEF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHIEF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHIEF actions', async () => {
      const arg = 42666;
