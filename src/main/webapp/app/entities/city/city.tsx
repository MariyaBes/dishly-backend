    ...
    <div>
      ...
      <div className="table-responsive">
        {cityList && cityList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('hasObject')}>
                  Has Object <FontAwesomeIcon icon={getSortIconByFieldName('hasObject')} />
                </th>
            ...
            <tbody>
              {cityList.map((city, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{city.city}</td>
                  <td>{city.hasObject ? 'true' : 'false'}</td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/city/${city.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">Cities не найдено</div>
        )}
      </div>
    </div>
  );
