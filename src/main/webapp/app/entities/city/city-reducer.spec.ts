...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './city.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CITY actions', async () => {
      const arg = 42666;
