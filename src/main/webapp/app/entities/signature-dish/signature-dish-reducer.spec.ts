...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIGNATUREDISH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SIGNATUREDISH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SIGNATUREDISH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SIGNATUREDISH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SIGNATUREDISH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SIGNATUREDISH actions', async () => {
      const arg = 42666;
