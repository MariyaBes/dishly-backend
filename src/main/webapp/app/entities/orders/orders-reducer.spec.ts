...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './orders.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERS actions', async () => {
      const arg = 42666;
