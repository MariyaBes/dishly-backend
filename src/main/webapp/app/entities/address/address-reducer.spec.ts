...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './address.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADDRESS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADDRESS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADDRESS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADDRESS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADDRESS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADDRESS actions', async () => {
      const arg = 42666;
