...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './menu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MENU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENU actions', async () => {
      const arg = 42666;
