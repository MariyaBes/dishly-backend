...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './kitchen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KITCHEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KITCHEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KITCHEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KITCHEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KITCHEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KITCHEN actions', async () => {
      const arg = 42666;
