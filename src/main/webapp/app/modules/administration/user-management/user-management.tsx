        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('login')}>
              Логин <FontAwesomeIcon icon={getSortIconByFieldName('login')} />
            </th>
            <th className="hand" onClick={sort('email')}>
              Эл. почта <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
            </th>
            <th />
            <th>Профили</th>
            <th className="hand" onClick={sort('createdDate')}>
              Дата создания <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              Изменено <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              Дата изменения <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
