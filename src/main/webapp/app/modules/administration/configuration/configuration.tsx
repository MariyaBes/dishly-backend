...
export const ConfigurationPage = () => {
  ...
  return (
    <div>
      ...
      <span>Фильтр (по префиксу)</span> <Input type="search" value={filter} onChange={changeFilter} name="search" id="search" />
      <label>Spring configuration</label>
      <Table className="table table-striped table-bordered table-responsive d-table">
        <thead>
          <tr>
            <th onClick={changeReversePrefix}>Префикс</th>
            <th onClick={changeReverseProperties}>Свойства</th>
          </tr>
        </thead>
        <tbody>
