package com.virality.dishly.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.virality.dishly.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.virality.dishly.security.DomainUserDetailsService", "createSpringSecurityUser");
